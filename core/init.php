...
require_once get_template_directory().'/core/custom_post_types.php';
require_once get_template_directory().'/core/custom_taxonomies.php';
// ACF
require_once get_template_directory().'/core/acf.php';
